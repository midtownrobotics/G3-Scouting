        ...
        <Container className="mt-4" id="home-page">
            <Card className="mb-4 shadow-sm">
                <Card.Body>
                    ...
                    <Card.Text>
                        <i className="mt-0 mb-4">"{userData?.user.title}"</i>
                        <p className="mb-0 mt-2">You have <b>{Math.round(userData.user.tokens * 100) / 100}</b> BoyleBucks and <b>{Math.round(userData.user.xp * 100) / 100}</b> XP.</p>
